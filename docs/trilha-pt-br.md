...
Se você prefere estudar em português, esta é a sequência usando **apenas** material PT-BR gratuito com certificado.
...
| # | Curso | Provedor |
|---|---|---|
| 6 | [Introdução à Cibersegurança](https://www.netacad.com/pt/courses/introduction-to-cybersecurity) | Cisco NetAcad |
| 7 | [Segurança em Tecnologia da Informação](https://www.ev.org.br/cursos/seguranca-em-tecnologia-da-informacao) | Fundação Bradesco |
| 8 | [Segurança da Informação para Todos](https://www.escolavirtual.gov.br/curso/1256) | Escola Virtual Gov |
| 9 | [CyberSecurity](https://www.eucapacito.com.br/cursos/cybersecurity/) | FIAP / Eu Capacito |
| 10 | [Segurança de Endpoint](https://www.netacad.com/pt/courses/endpoint-security) | Cisco NetAcad |
...
- [Como implementar a LGPD](https://www.escolavirtual.gov.br/curso/529)
- [Atuação do Encarregado na LGPD](https://www.escolavirtual.gov.br/curso/1041)
...
## Leitura 🇧🇷
- [Cartilha de Segurança para Internet](https://cartilha.cert.br/) — CERT.br
- [Fundamentos de Engenharia Reversa](https://mentebinaria.gitbook.io/engenharia-reversa) — Mente Binária
- Livros da Novatec (Daniel Moreno, Yuri Diógenes) → [`livros/pagos.md`](../livros/pagos.md)

## Aviso honesto

O conteúdo avançado da área é majoritariamente em inglês. Esta trilha te leva bem até o nível intermediário — depois disso, **ler inglês técnico deixa de ser opcional**. A boa notícia: ler é muito mais fácil que falar, e você já vai conhecer o vocabulário.
