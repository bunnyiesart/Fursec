...
| [`cursos/`](./cursos/) | O catálogo: dezoito arquivos, um por área — 00 a 07 na trilha principal, 08 a 17 na camada paga e nas especializações. Todo curso vem marcado com idioma, gratuidade, certificado e prioridade. | **267 cursos** (262 gratuitos) | [Introdução](./cursos/01-introducao-seguranca.md) |
