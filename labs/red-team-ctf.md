...
|---|---|---|---|
| ⭐ [picoCTF](https://picoctf.org/) | 🇺🇸 | 🆓 🧪 | Melhor CTF para começar |
| ⭐ [OverTheWire](https://overthewire.org/wargames/) | 🇺🇸 | 🆓 🧪 | Bandit → Natas → Leviathan |
| [Hack The Box](https://www.hackthebox.com/) | 🇺🇸 | 🆓 parcial 🧪 | Máquinas ativas grátis |
| [VulnHub](https://www.vulnhub.com/) | 🇺🇸 | 🆓 🧪 | VMs vulneráveis para baixar |
| [Root-Me](https://www.root-me.org/) | 🇺🇸🇧🇷 | 🆓 🧪 | Interface em PT disponível |
| [CTFtime](https://ctftime.org/) | 🇺🇸 | 🆓 | Calendário de CTFs mundiais |
| [DVWA](https://github.com/digininja/DVWA) | 🇺🇸 | 🆓 🧪 | Damn Vulnerable Web App |
| [OWASP Juice Shop](https://owasp.org/www-project-juice-shop/) | 🇺🇸 | 🆓 🧪 | App vulnerável moderno |
